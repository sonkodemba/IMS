      ...
      <div class="card-body">
          <div class="form-group row">
              ...
              <div class="col-sm-4 input-group input-group-sm">
                  <div class="input-group-append">
                      <input type="type" style="background-color: lightyellow; font-size: 24px; font-family: sans-serif bold; color: red; font-weight: bolder;"  name="code" value="{{$department -> code}}" class="form-control" id="Name">
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-10 input-group input-group-sm">
                  <div class="input-group-append">
                      <input type="text" style="background-color: lightyellow; font-size: 24px; font-family: sans-serif bold; color: red; font-weight: bolder;"  name="name" value="{{$department -> name}}" class="form-control" id="Name" >
          ...
          <div class="form-group row">
              <label style="text-align: right; color: #0E0EFF" for=" Code" class="col-sm-2 col-form-label">Descriptions:</label>
              <div class="col-sm-10 input-group input-group-sm">
                  <div class="input-group-append">
                      <input type="text" style="background-color: lightyellow; font-size: 24px; font-family: sans-serif bold; color: red; font-weight: bolder;"  name="descriptions" value="{{$department -> descriptions}}" class="form-control" id="Name" >
